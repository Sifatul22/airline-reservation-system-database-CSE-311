...
if(isset($_POST['submit'])){
    ...
    $query = "update passenger set passport_number=$passport_number, customer_name = '$customer_name', date_of_expiry='$date_of_expiry', phone_number = $phone_number, address= '$address', country= '$country' where passport_number = $passport_number";
...
<form action="update_customer.php" method="post">
  ...
  <div class="form-group">
    ...
    <input type="text" name="customer_name" class="form-control" id="" placeholder="Your Name">
  </div>
  <div class="form-group">
    <label for="doe">Date Of Expiry</label>
    <input type="date" name="date_of_expiry" class="form-control" id="" placeholder="Expiry Date">
  </div>
  <div class="form-group">
    <label for="phone_number">Phone Number</label>
    <input type="text" name="phone_number" class="form-control" id="" placeholder="Your Phone Number">
  </div>
