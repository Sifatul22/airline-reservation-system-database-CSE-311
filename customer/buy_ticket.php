    ...
    <ul class="navbar-nav mr-auto">
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="flight_details.php">Flight Info</a>
        </div>
      </li>
...
<form action="buy_ticket.php" method="post">
  <div class="form-group">
    ...
    <input type="number" name="passport_number" class="form-control" id="" aria-describedby="emailHelp" placeholder="Enter passport number">
  </div>
  <div class="form-group">
